...
# In Fedora 26-x86, you typically find it at: /lib64/libatomic.so.1
# In Ubuntu-AArch64, you typically find it at: /usr/lib/aarch64-linux-gnu/libatomic.so.1

# In Fedora 26-x86, you have to separately install it (yum install libatomic).
...
ELSE ()
    ...
    MESSAGE(STATUS "Try:  'sudo apt-get install libatomic1'")
ENDIF ()
