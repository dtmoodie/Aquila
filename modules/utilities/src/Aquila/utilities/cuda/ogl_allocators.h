...
namespace aq
{
    ...
    class AQUILA_EXPORTS ref_buffer : public cv::ogl::Buffer
    {
    ...
    class AQUILA_EXPORTS ogl_allocator : public CombinedAllocator, public pool::ObjectPool<cv::ogl::Buffer>, public IObject
    {
    protected:
