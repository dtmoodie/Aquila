...
namespace aq
{
    class ParameterSynchronizer
    {
      public:
         ...
         */
        template <class... Types>
        bool getNextSample(std::tuple<mo::TDataContainerConstPtr_t<Types>...>& data,
                           mo::IAsyncStream* stream = nullptr);
...
namespace aq
{
    ...
    {
        ScatterDataHelper(ct::TArrayView<mo::IDataContainerConstPtr_t>& vec)
            : m_vec(vec)
        {
        }
    ...
    template <class... Types, size_t... I>
    bool
    ParameterSynchronizer::unpackTuple(std::tuple<Types...>& data, ct::IndexSequence<I...>, mo::IAsyncStream* stream)
    {
    ...
    template <class... Types>
    bool ParameterSynchronizer::getNextSample(std::tuple<mo::TDataContainerConstPtr_t<Types>...>& data,
